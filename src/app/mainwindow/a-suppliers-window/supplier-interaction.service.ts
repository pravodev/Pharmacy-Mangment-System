...
export class SupplierInteractionService {
  ...
  getSupplier() {
    this.http.get<{message: string, suppliers: any}>('https://apipms.demo-kota.com/api/supplier')
  ...
  getSuppiers(id: string){
    ...
    ('https://apipms.demo-kota.com/api/supplier/' + id);
  }
  ...
  addSupplier( supplierID: string, name: string, email: string, contact: string, drugsAvailable: string) {
    ...
    this.http.post<{message: string, supplierId: string}>('https://apipms.demo-kota.com/api/supplier',supplier)
  ...
  deleteSupplier(supplierId: string) {
    this.http.delete('https://apipms.demo-kota.com/api/supplier/' + supplierId)
      .subscribe(() => {
