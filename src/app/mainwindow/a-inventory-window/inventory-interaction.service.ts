...
export class InventoryInteractionService {
  ...
  getInventory(itemsPerPage: number , currentPage:number) {
    ...
    this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory' + queryParams)
  ...
  getOutofStockInventory() {
    ...
    this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory/outofstock' )
    .pipe(map(inventoryData => {
     return inventoryData.inventorys.map(inventory=>{
       return{
        email: inventory.email,
  ...
  getAboutToOutofStockInventory() {
    ...
    this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory/abouttooutofstock' )
    .pipe(map(inventoryData => {
     return inventoryData.inventorys.map(inventory=>{
       return{
        email: inventory.email,
  ...
  getExpiredInventory(){
    this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory/getExpired')
    .pipe(map(inventoryData => {
     return inventoryData.inventorys.map(inventory=>{
       return{
        email: inventory.email,
  ...
  getAboutToExpireInventory(){
    ...
    this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory/getAboutToExpire')
    .pipe(map(inventoryData => {
     return inventoryData.inventorys.map(inventory=>{
       return{
        email: inventory.email,
  ...
  //   this.http.get<{message: string, inventorys: any}>('https://apipms.demo-kota.com/api/inventory/' + id)
  //   .pipe(map(inventoryData => {
  //     return inventoryData.inventorys.map(inventory=>{
  //       return{
  //        name: inventory.name,
  ...
  getInventorys(id: string){
    ...
    ('https://apipms.demo-kota.com/api/inventory/' + id);
  }
  ...
  addInventory( email: string, name: string, quantity: string, batchId: string, expireDate: string, price: string , image: File) {
    ...
    this.http.post<{message: string, inventory: Inventory}>('https://apipms.demo-kota.com/api/inventory',inventoryData)
  ...
  updateInventory(id: string , email: string ,name: string, quantity: string, batchId: string, expireDate: string, price: string ,image: File | string){
    ...
    this.http
             .put('https://apipms.demo-kota.com/api/inventory/' + id , inventoryData)
             .subscribe(response => {
  ...
  updateQuantity(id: string ,quantity: number){
    ...
    this.http
             .put('https://apipms.demo-kota.com/api/inventory/updateQuantity/' + id , inventory)
             .subscribe(response => {
  ...
  deleteInventory(inventoryId: string) {
    this.http.delete('https://apipms.demo-kota.com/api/inventory/' + inventoryId)
      .subscribe(() =>{
