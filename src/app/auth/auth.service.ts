...
export class AuthService{
  ...
  createUser(name: string , contact: string , nic: string ,email: string ,password: string , role : string){
    ...
    this.http.post("https://apipms.demo-kota.com/api/user/signup",authData)
      .subscribe(response =>{
  ...
  login(email: string, password){
    ...
    this.http.post<{token: string, expiresIn: number, role :string , message: string}>("https://apipms.demo-kota.com/api/user/login",authData)
      .subscribe(response =>{
  ...
  getUserDatas(id: string){
    ...
    ('https://apipms.demo-kota.com/api/user/' +id);
  }


  getUser() {
    this.http.get<{message: string, users: any}>('https://apipms.demo-kota.com/api/user/getUserData')
    .pipe(map(userData => {
  ...
  updateUser(id: string ,  name: string, email: string, nic: string, contact: string, password: string, role: string){
    ...
    this.http
             .put('https://apipms.demo-kota.com/api/user/' +id , user)
             .subscribe(response => {
  ...
  deleteUser(userId: string) {
    this.http.delete('https://apipms.demo-kota.com/api/user/' +userId)
      .subscribe(() => {
